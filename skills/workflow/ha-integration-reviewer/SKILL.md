...
description: >-
  Strict Home Assistant integration code review for PR preparation.
  Covers Quality Scale rules, code style, Config Flow, test coverage, and docs.
  Triggers on "review my HA integration", "check HA compliance", "HA code review",
  "审查我的 HA 集成", "检查我的代码是否符合 HA 规范", "帮我 review 一下准备提交的代码".
---
